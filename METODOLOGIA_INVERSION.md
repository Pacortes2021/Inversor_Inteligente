...
3. **Normalizar la capacidad de generar caja.** El DCF usa una base robusta entre FCF TTM, último anual y promedio reciente. Si el flujo más reciente no es positivo, el DCF se desactiva. Esta normalización aún no separa automáticamente capex de mantenimiento, compensación en acciones ni partidas extraordinarias: el usuario debe revisarlas en los estados financieros.
...
9. **Documentar la decisión.** La ficha exige tesis, tres motores, tres riesgos, señales para aumentar, condiciones de invalidación y peso máximo.
...
El screener calcula únicamente lo que puede observar en datos estructurados. Muestra su cobertura y deja pendiente el encaje de cartera. La caída desde máximos aparece como contexto y no suma puntos.
