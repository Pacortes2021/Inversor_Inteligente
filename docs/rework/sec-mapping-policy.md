...
Un instante nunca recibe fecha inicial. Los hechos de duración se clasifican como FY, trimestre independiente o YTD usando formulario, período fiscal, frame y duración. Como los frames SEC son calendarios, un trimestre sólo se rotula fiscal cuando año y trimestre calendario coinciden con `fy/fp`; los emisores con calendario no coincidente quedan bloqueados hasta incorporar un calendario fiscal identificado. Un FY requiere 10-K, entre 301 y 380 días y año fiscal compatible con su cierre. TTM exige cuatro trimestres fiscales únicos de 60–120 días, consecutivos, con fechas contiguas y una ventana total de 330–380 días, o el puente exacto `FY anterior + YTD actual − YTD comparable anterior`; los YTD del puente deben durar 121–300 días y el comparable debe terminar dentro del FY. Ambas rutas aceptan sólo conceptos aditivos y entradas disponibles, válidas y sin conflicto, y generan linaje tipado con todos sus inputs.
