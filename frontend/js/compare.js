...
import { fmtPrice, fmtBig, fmtPct, fmtRatio, escHtml, pctClass } from "./format.js?v=90";
import { renderCompareCharts, charts } from "./charts.js?v=90";
...
const CMP_ROWS = [
  ...
  ["Valor base", d => (d.valuation.baseValue ?? d.valuation.consensus) != null ? fmtPrice(d.valuation.baseValue ?? d.valuation.consensus, d.profile.currency) : "—"],
