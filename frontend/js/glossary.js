...
const GLOSSARY = {
  ...
  mos: { t: "Margen de seguridad", d: "Distancia entre el valor base estimado y el precio. La app exige un margen mayor cuando observa menos historia, flujos volátiles, márgenes inestables o desacuerdo entre modelos. No sustituye revisar la tesis.", e: "Valor base $130, precio $100 → margen estimado +30%." },
  consenso: { t: "Valor base", d: "Estimación del modelo principal que mejor se adapta al negocio. Los demás modelos sirven como contraste y no se promedian mecánicamente, porque pueden medir cosas distintas.", e: "Una empresa operativa con FCF predecible usa DCF como método principal; Graham y PE histórico quedan como referencias." },
  buyprice: { t: "Precio con margen exigido", d: "Valor base dividido por uno más el margen requerido. La exigencia varía entre 15% y 40% según la incertidumbre cuantitativa observada.", e: "Valor base $100 y margen exigido 25% → umbral $80." },
  ...
  drawdown: { t: "vs máximo 52 semanas", d: "Cuánto ha caído desde el máximo del último año. Es solo contexto de precio: una caída puede reflejar una oportunidad o un deterioro real y no aumenta por sí sola el puntaje de inversión.", e: "" },
  ...
  score: { t: "Puntaje cuantitativo", d: "Filtro inicial de valoración, calidad, salud financiera, crecimiento y riesgo. El encaje en tu cartera y la ventaja competitiva requieren revisión humana; el puntaje ordena candidatos y no recomienda comprar.", e: "" },
